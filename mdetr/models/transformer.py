...
class Transformer(nn.Module):
    ...
    def forward(
        ...
        return memory_cache, hs.transpose(1, 2)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(
        ...
        tgt_cross_attn = self.cross_attn_image(
